    ...
    (response =>response.json()).then(responseJson => {
        ...
        for(let i=0;i<responseJson.length;i++){
            ...
            <p><span>address:</span> ${responseJson[i].address}</p>
           ...
           <p><span>geo</span>: ${responseJson[i].geo}</p>
           <p><span>lat</span>: ${responseJson[i].lat}</p>
           <p><span>lng</span>: ${responseJson[i].lng}</p>
           <p><span>phone</span>: ${responseJson[i].phone}</p>
           <p><span>website</span>: ${responseJson[i].website}</p>
           <p><span>company</span>: ${responseJson[i].company}</p>
